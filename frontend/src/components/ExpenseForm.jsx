...
function ExpenseForm() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get('https://possystem-eo7h.onrender.com/api/expenses/categories');
  ...
  const handleAddCategory = async (e) => {
    ...
    try {
      await axios.post('https://possystem-eo7h.onrender.com/api/expenses/categories', { name: newCategory });
      setNewCategory('');
      const response = await axios.get('https://possystem-eo7h.onrender.com/api/expenses/categories');
      setCategories(response.data);
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://possystem-eo7h.onrender.com/api/expenses', {
        name: formData.name,
