...
function InvoiceForm() {
  ...
  const fetchLatestInvoiceNo = async () => {
    try {
      const res = await axios.get('https://possystem-eo7h.onrender.com/api/invoices/latest');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://possystem-eo7h.onrender.com/api/invoices', invoiceData);
      await generatePDF();
      navigate('/invoices');
    } catch (err) {
